...
public class TreeStructureController {
    ...
    @RequestMapping(value = "/studies/{studyId}/patients/{patientId}/phylogenetic-tree-structure", method = RequestMethod.GET,
        produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation("Get phylogenetic tree for a patient in a study")
    public ResponseEntity<List<TreeStructure>> getTreeStructureInPatientInStudy(
        ...
        return new ResponseEntity<>(
            treeStructureService.getTreeStructureInPatientInStudy(studyId, patientId,
    ...
    public ResponseEntity<List<TreeStructure>> fetchTreeStructure(
        ...
        return new ResponseEntity<>(
            treeStructureService.fetchTreeStructure(studyIds, patientIds, projection.name()), 
            HttpStatus.OK);
