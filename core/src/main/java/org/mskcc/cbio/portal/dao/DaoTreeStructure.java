 ...
 * @author jgao
 */
public final class DaoTreeStructure {
    private DaoTreeStructure() {}
    
    public static int addTreeStructure(TreeStructure tree) throws DaoException {
    ...
    public static long getLargestId() throws DaoException {
        ...
        ResultSet rs = null;
        try {
            con = JdbcUtil.getDbConnection(DaoTreeStructure.class);
            ...
            JdbcUtil.closeAll(DaoTreeStructure.class, con, pstmt, rs);
        }
    }

    public static List<TreeStructure> getTreeForAPatient(
    ...
    public static List<TreeStructure> getTreeForPatients(
